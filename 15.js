...
const sketch = (props) => {
  ...
  // dotCheckpoints.push(
  //   // generateBlob(3, -5, -9.5, 1, 1.3, width, height, noPoints)  
  //   generateBlob(3.5, 5, -3, 2, 0.4, width, height, noPoints)  
  // )
  ...
  drawInterpolation({
    dotCheckpoints: dotCheckpoints3,
    circleResolution: noPoints,
    interpResolution,
    horizontalStripes: true,
  ...
  drawInterpolation({
    dotCheckpoints: dotCheckpoints4,
    circleResolution: noPoints,
    interpResolution,
    horizontalStripes: true,
    verticalStripes: true,
